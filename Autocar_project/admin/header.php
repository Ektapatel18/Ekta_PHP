...
<!----->
        <nav class="navbar-default navbar-static-top" role="navigation">
             <div class="navbar-header">
               ...
               <h1> <a class="navbar-brand" href="dashboard">Vehicales</a></h1>         
			   </div>
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="drop-men" >
		        <ul class=" nav_1">
					...
					<li class="dropdown">
		              <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret">EKTA<i class="caret"></i></span><img src="images/wo.jpg"></a>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="manage_employee" class=" hvr-bounce-to-right"><i class="fa fa-user nav_icon"></i>Manage Emplyee</a></li>		
					   </ul>
                    </li>
					<li>
